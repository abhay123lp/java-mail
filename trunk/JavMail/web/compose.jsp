...
<html>
    ...
    <body>
     ...
     <input type="file" id="filename" name="filename" value="" onChange="this.form.txtFilePath.value=this.value">
     <input type="text" id="txtFilePath" name="txtFilePath" value=""> 
            ...
            <tr>
                <td colspan="2" ><textarea name="body" rows="20" cols="60">Enter message here. You can attach Files with username password</textarea> </td>
